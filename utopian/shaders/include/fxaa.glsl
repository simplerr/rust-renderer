...
vec3 fxaa(vec2 uv, sampler2D inputTexture)
{
   ...
   */
   ...
   if(lumaRange < max(EDGE_THRESHOLD_MIN, lumaMax * settings_fxaa.enabled_debug_threshold.z))
   {
      return colorCenter;
   }

   /**
      Calculate if horizontal or vertical edge
   */
   ...
   */
   ...
   vec2 inverseScreenSize = vec2(1.0f / SCREEN_WIDTH, 1.0f / SCREEN_HEIGHT);
